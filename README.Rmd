...
2. Render the site and serve it from the same place, watching for changes to re-render.
...
3. Launch a web page to list and preview R Markdown and HTML files under the same directory.
